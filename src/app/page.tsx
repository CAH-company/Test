        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="mb-10">
            <Link href={`/realizacje/${featured[0].slug}`} className="block group">
              <div className="bg-white rounded-3xl overflow-hidden card-cream transition-all border border-gray-200">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {featured.slice(1).map((cs) => (
              <Link key={cs.slug} href={`/realizacje/${cs.slug}`} className="block group">
                <div className="bg-white rounded-3xl overflow-hidden card-cream transition-all border border-gray-200 h-full">
